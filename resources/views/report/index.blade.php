                    ...
                    <div class="row">
                        <div class="col-12 col-md-3">
                            <div class="mb-2">
                                ...
                                <select name="office_filter" id="office-filter" class="js-example-basic-single form-control" data-width="100%" data-toggle="select2">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="mb-2">
                                ...
                                <select name="technician_filter" id="technician-filter" class="js-example-basic-single form-control" data-width="100%" data-toggle="select2">
                                    <option selected disabled>All Technician</option>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="mb-2">
                            <label class="form-label">Technician</label>
                            <select name="technician_export" id="technician-export" class="js-example-basic-single form-select" data-width="100%">
                                <option selected disabled>All Technician</option>
                                @foreach ($technician as $data)
                                <option value="{{ $data->id }}">{{ $data->name }}</option>
                                @endforeach
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        let dataTable = $("#datatable").DataTable({
            ...
            ajax: {
                ...
                data: function(d) {
                    ...
                    d.technician_id = Number($('select[name=technician_filter] option:selected').val())
        ...
        exportModal.addEventListener('show.bs.modal', function (event) {
            ...
            $("#technician-export").prop('selectedIndex', 0).change();
        ...
        $('#btn-export-pdf').on('click', function() {
            ...
            var technician = Number($('select[name=technician_export] option:selected').val());
            var start_date = $('input[name=start_date_export]').val();
            var end_date = $('input[name=end_date_export]').val();
            var url = `{{ route('report.ticket.exportPdf') }}?start_date=${start_date}&end_date=${end_date}&office=${office}&category=${category}&technician=${technician}`;
        ...
        $('#btn-reset').on('click', function(){
            ...
            $("#technician-filter").prop('selectedIndex', 0).change();
